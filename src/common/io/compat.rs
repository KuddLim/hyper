    ...
    T: crate::rt::AsyncRead,
{
    fn poll_read(
        ...
        let (new_init, new_filled) = unsafe {
            ...
            match crate::rt::AsyncRead::poll_read(self.p(), cx, buf.unfilled()) {
    ...
    T: crate::rt::AsyncWrite,
{
    fn poll_write(
        ...
        crate::rt::AsyncWrite::poll_write(self.p(), cx, buf)
    }

    fn poll_flush(self: Pin<&mut Self>, cx: &mut Context<'_>) -> Poll<Result<(), std::io::Error>> {
        crate::rt::AsyncWrite::poll_flush(self.p(), cx)
    }
    ...
    fn poll_shutdown(
        ...
        crate::rt::AsyncWrite::poll_shutdown(self.p(), cx)
    }

    fn is_write_vectored(&self) -> bool {
        crate::rt::AsyncWrite::is_write_vectored(&self.0)
    }
    ...
    fn poll_write_vectored(
        ...
        crate::rt::AsyncWrite::poll_write_vectored(self.p(), cx, bufs)
    }
}

#[cfg(test)]
impl<T> crate::rt::AsyncRead for Compat<T>
where
...
#[cfg(test)]
impl<T> crate::rt::AsyncWrite for Compat<T>
where
